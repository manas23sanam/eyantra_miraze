...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        try:
            ...
            cv2.putText(black_screen, f'ACTIVE LEG: {active_leg}', (30, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2, cv2.LINE_AA)
            y_offset = 90
        ...
        cv2.putText(black_screen, 'Waiting for full body in frame (Need to see ankles)...', (50, frame.shape[0] // 2), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2, cv2.LINE_AA)
