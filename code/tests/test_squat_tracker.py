...
from detectors.squat_angle_detector import SquatRepCounter
...
def test_asymmetric_rep():
    ...
    counter.update(120, angle_diff=5)
...
def test_wide_knees_rep():
    ...
    counter.update(120, knee_dist=300)
...
def test_bad_torso_lean_rep():
    ...
    counter.update(120, torso_lean=10)
